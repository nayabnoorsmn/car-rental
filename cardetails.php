...
.box .book-btn:is(:hover, :focus, :active){
    background: orange;
    border: none;
    outline: none;
        ...
        <div class="navbar">
            ...
            <div class="menu">
                ...
                <ul>
                    ...
                    <li><p class="phello">HELLO! &nbsp;<a id="pname"><?php echo $rows['FULLNAME']?></a></p></li>
       ...
       <div class="imgBx">
        ...
        <div class="content">
            ...
            <h2>Rent Per Day : <a>₹<?php echo $result['PRICE']?>/-</a></h2>
             <a class="book-btn" href="booking.php?id=<?php echo $res;?>">book</a>
        </div>
    </div></form></li>
    <?php
        }
